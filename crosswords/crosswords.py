...
class Crossword:
    ...
    def check_if_cell_clear(self, row, col):
        try:
...
word_list = [
    ...
    ('caramel', 'A smooth chery candy made from suger, butter, cream or milk with flavorîng.'),
    ('coral', 'A rock-like deposit of organism skeletons that make up reefs.'),
    ('down', 'The time of each morning at which daylight begins.'),
    ...
    ('lime', 'The egg-shaped citrus fruit having a green colcring and acidic'),
    ('mist', 'A mass of fine water droplets in the air near cr in contact ith the ground.'),
    ('plague', 'A widespread affliction or calamity.'),
    ('yarn', 'A strand ot twisted threads or a long elaborate narrative.'),
    ('snicker', 'A anide, slightly stifled laugh.')
]
